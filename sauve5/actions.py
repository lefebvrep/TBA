...
class Actions:
    ...
    def go(game, list_of_words, number_of_parameters):
        ...
        """
        if DEBUG:
            print(f"DEBUG: commande go appelée avec {list_of_words}")
        player = game.player
        l = len(list_of_words)
    ...
    def take(game, list_of_words, number_of_parameters):
        """
        Prendre un item dans la pièce courante : take <nom_item>
    ...
    def look(game, list_of_words, number_of_parameters):
        """
        Affiche la description de la pièce actuelle et la liste des objets présents.

        La commande ne prend aucun paramètre.

        Args:
            game (Game): Le jeu.
            list_of_words (list): Les mots tapés par le joueur.
        ...
        # On affiche d'abord la description longue
    ...
    def drop(game, list_of_words, number_of_parameters):
        """
        Poser un objet dans la pièce courante.
        Usage: drop <nom_item>
        """
        l = len(list_of_words)
        if l != number_of_parameters + 1:
        ...
        player = game.player
        item_key = list_of_words[1]
        return player.drop(item_key)
